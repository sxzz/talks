...
<template>
  <div class="architecture mt--8 text-xs">
    <div mt4 flex justify-right text-xs text="$text-secondary" font-semibold>
      <div>Made by Rizumu Ayaka</div>
    </div>
    ...
    >
      ...
      >
        ...
        <p text-sm>Final Result｜<span font-jp>最終結果</span></p>
      </div>
      <!-- 箭头 -->
      <div>
        <!-- SFC -->
        ...
        <div
          ...
          pb-16
          transition="all duration-500 ease-in-out"
          :class="$clicks >= 4 ? 'translate-y-0' : 'translate-y--100 op0'"
        >
          <div
            border="$color-jsx"
            w-full
